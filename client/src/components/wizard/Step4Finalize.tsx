...
import { Camera, CheckCircle2, ShieldCheck, MapPin, ScanLine, AlertCircle, XCircle } from "lucide-react";
...
export function Step4Finalize({ data, updateData, onSubmit, onBack, isSubmitting, onCancelSale }: Props) {
  ...
  const handleFinish = () => {
    ...
    if (!(data as any).addressVillage) newErrors.addressVillage = true;
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2" ref={fieldRefs.cityDistrict}>
                ...
                <Input
                  placeholder="მაგ: თბილისი ან ახმეტა"
                  value={(data as any).cityDistrict || ""}
                  onChange={(e) => {
                    updateData({ cityDistrict: e.target.value } as any);
                    setErrors(prev => ({ ...prev, cityDistrict: false }));
                  }}
                  className={cn("h-11 rounded-xl", errors.cityDistrict && "border-destructive bg-destructive/5")}
                />
              </div>
              ...
              <div className="space-y-2" ref={fieldRefs.addressVillage}>
                ...
                <Input
                  placeholder="მაგ: კეკელიძის 40 ან ზემო ალვანი"
      ...
      <div className="pt-6 flex justify-between items-center border-t border-border mt-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            disabled={isSubmitting || isCancelling || !addressesComplete}
